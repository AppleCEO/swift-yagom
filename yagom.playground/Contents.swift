...
// 클로저의 사용
var sum17: (Int, Int) -> Int = { (a: Int, b: Int) -> Int in
    return a + b
}
...
func calculate18(a: Int, b: Int, method: (Int, Int) -> Int) -> Int {
    return method(a, b)
}
...
result = calculate18(a: 10, b: 10) { (left: Int, right: Int) -> Int in
    return left + right
}
...
result = calculate18(a: 10, b: 10, method: { (left: Int, right: Int) in
    return left + right
})
...
result = calculate18(a: 10, b: 10) { (left: Int, right: Int) in
    return left + right
}
...
result = calculate18(a: 10, b: 10, method: {
    return $0 + $1
})
...
result = calculate18(a: 10, b: 10) { $0 + $1 }

print(result) // 20

// 축약하지 않은 클로저 문법과 축약 후의 문법 비교

result = calculate18(a: 10, b: 10, method: { (left: Int, right: Int) -> Int in
    return left + right
})
...
// 타입 연산 프로퍼티 사용
print(Student19.selfIntroduction)
// 학생타입입니다

// 인스턴스 생성
var yagom19: Student19 = Student19()
yagom19.koreanAge = 10
...
// 인스턴스 연산 프로퍼티 사용
print(yagom19.selfIntroduction)
// 저는 Swift반 yagom입니다

print("제 한국나이는 \(yagom19.koreanAge)살이고, 미쿡나이는 \(yagom19.westernAge)살입니다.")
...
var moneyInMyPocket20: Money20 = Money20()

// 환율이 1100.0에서 1150.0으로 변경될 예정입니다
moneyInMyPocket20.currencyRate = 1150
// 환율이 1100.0에서 1150.0으로 변경되었습니다

// 0.0달러에서 10.0달러로 변경될 예정입니다
moneyInMyPocket20.dollar = 10
// 0.0달러에서 10.0달러로 변경되었습니다

print(moneyInMyPocket20.won)
// 11500.0
...
var a20: Int = 100 {
    willSet {
        print("\(a20)에서 \(newValue)로 변경될 예정입니다")
    }
    
    didSet {
        print("\(oldValue)에서 \(a20)로 변경되었습니다")
    }
}
